...
- (void)startAsynchronous {
    ...
    if(useUploadTaskInBackground) {
        ...
        [self.request.HTTPBody writeToURL:_HTTPBodyFileURL atomically:YES];
        self.task = [session uploadTaskWithRequest:self.request fromFile:_HTTPBodyFileURL];
    } else {
...
-(NSURLSessionTaskState)downloadStatus
{
    return _task.state;
}
...
didReceiveResponse:(NSURLResponse *)response
 completionHandler:(void (^)(NSURLSessionResponseDisposition disposition))completionHandler {
    ...
    //save instacnce which will be used for resuming task
    //_datatask = dataTask;
